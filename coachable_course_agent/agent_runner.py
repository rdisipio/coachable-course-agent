...
from coachable_course_agent.linkedin_tools import profile_extract_tool, get_skill_tool, get_save_profile_tool
...
def create_profile_building_agent(vectorstore, user_id):
    ...
    tools = [profile_extract_tool, get_skill_tool(vectorstore), get_save_profile_tool(user_id)]
