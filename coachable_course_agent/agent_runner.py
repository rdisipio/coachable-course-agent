...
from coachable_course_agent.prompts.recommendation_prompt import base_prompt

load_dotenv()

# Initialize LLM
llm = Groq(model="llama3-70b-8192", temperature=0.7, api_key=os.getenv("GROQ_API_KEY"))
